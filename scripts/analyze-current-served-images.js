...
for (const [town, images] of Object.entries(expertConfirmed)) {
...
for (const imageObj of staticImages) {
    ...
    // Extract the image ID from the filename (remove .jpg extension)
    const imageId = imageObj.filename.replace('.jpg', '');
