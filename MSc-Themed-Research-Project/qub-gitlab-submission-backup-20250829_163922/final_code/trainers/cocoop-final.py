...
class PromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.meta_net = nn.Sequential(
            OrderedDict([("linear1", nn.Linear(1024, 1024 // 16)), #vis_dim
        ...
        prompts = [prompt_prefix + " " + name[1] + ", " +ctx_init2 + " " + name[2] + ", " +ctx_init3 + " "+ name[3]+ "." for name in classnames]
