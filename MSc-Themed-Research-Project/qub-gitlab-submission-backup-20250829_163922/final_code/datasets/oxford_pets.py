...
#                 if relabeler[item.label]==i:
#                     print('label',relabeler[item.label])
...
#                     i=i+1
# #                     name=str()
# #                     label=str(item.label+1)
# #                     new= os.path.join(label+'_'+name)
#                     #print('item.label',item.label)
#                     #name=str(item.classname)
#                     #name_number=name[:4]
#                     #name=name[5:]
#                     #name=name.join(name_number,name)
#                     #name=name.replace(' ','_')
#                     print(item.label+1,item.classname)
#         exit()
...
#                     j=1
#                     i=i+1
#                     names=str(item.classname)
#                     names = names.split(" ")[:]
#                     new_classname='_'.join(names)
#                     label=str(item.label+1)
#                     #new= os.path.join(label+'_'+new_classname)
#                     #print('item.label',item.label)
#                     #name=str(item.classname)
#                     #name_number=name[:4]
#                     #name=name[5:]
#                     #name=name.join(name_number,name)
#                     #name=name.replace(' ','_')
#                     print(item.label+1,new_classname)
#         exit()
#             for item in dataset:
