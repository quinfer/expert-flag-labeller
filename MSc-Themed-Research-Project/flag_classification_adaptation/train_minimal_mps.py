...
try:
    import datasets.ni_flags_consolidated  # Import consolidated dataset
    print("✅ Successfully imported NIFlagsConsolidated dataset")
except ImportError as e:
    print(f"❌ Failed to import NIFlagsConsolidated dataset: {e}")

try:
    import datasets.ni_flags_super_consolidated  # Import super-consolidated dataset
    print("✅ Successfully imported NIFlagsSuperConsolidated dataset")
except ImportError as e:
    print(f"❌ Failed to import NIFlagsSuperConsolidated dataset: {e}")
