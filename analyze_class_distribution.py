...
def main():
    ...
    try:
        # Load annotations
        annotations = load_annotations('../data/ni_flags/annotations.json')
        ...
        with open('detailed_class_statistics.json', 'w') as f:
            json.dump(stats_report, f, indent=2)
        
        print(f"\n💾 Detailed statistics saved to 'detailed_class_statistics.json'")
